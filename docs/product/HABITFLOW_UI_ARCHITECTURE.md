...
| Health Hub | Modal | Wellbeing card 💊 Health (or Overview) | Entry points for Sleep, Medications, Supplements, Symptoms, Weight, Caffeine, and Alcohol | Wellbeing Entries, Medications, Supplements, Symptoms |
...
| Health Factor Log | Modal | Health hub → Weight / Caffeine / Alcohol | Generic once-per-day numeric logger; caffeine/alcohol offer additive quick-add presets | Wellbeing Entries |
